      		...
      		jQuery(document).ready(function(){
               ...
               jQuery(".archive .shop_header_banner").prepend(cart);
      		  ...
      		  jQuery(".single-post .top_panel_title").prepend('<div class="arrow-left-icon"><a href="/wineclub/stories"><i class="icon-arrow-left-alt" aria-hidden="true"></i></a></div>');
      		   ...
      		   jQuery(".archive .inner_banner-content").append("<div class='shop-topcontent'><p>Brexit has brought about a number of additional ‘friction’ costs in selling to the UK.</p><p>While we have tried to absorb most of these, unfortunately we cannot avoid a modest price.</p><p>The prices shown include shipping to the country below.</p> <p>If you would like to ship to another country, please select here. </p></div>");
